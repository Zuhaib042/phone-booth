  ...
  var body: some View {
    List {
      Section {
        ...
        Text(
          "The allowance limits outgoing offers in this match. Receiving coins never increases it.")
      }
      ...
      Section {
        NavigationLink {
          ...
          Label("Find a Match", systemImage: "person.3.fill")
        }
        .buttonStyle(BoothPrimaryButtonStyle())
        .listRowInsets(EdgeInsets())
        .listRowBackground(Color.clear)
        .accessibilityIdentifier("preparation.find-match")
      }
    }
